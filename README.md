...
python3 draw_infer_hiragana73_ctc_tk.py --model runs/hiragana73_ctc/model_torchscript.pt --vocab runs/hiragana73_ctc/vocab.json --max_w 64 --target_h 32 --device cpu
